...
insert into Staff values('SG37','Ann','Beech','Assistant','F','1960-11-10',12000,'B003');
 insert into Staff values('SG14','David','Ford','Supervisor','M','1954-03-24',18000,'B003');
 insert into Staff values('SA9','Mary','Howe','Assistant','F','1958-02-19',9000,'B007');
...
insert into Client values('CR62','Mary','Tregear',01224-196720,'Flat',600,'mary@hotmail.co.uk');			
 

insert into PrivateOwner values('CO46','Joe','Keogh','2 Fergus Dr,Aberdeen AB2 7SX',01224-861212,'jkeogh@lhh.com','********');
insert into PrivateOwner values('CO87','Carol','Ferrel','6 Achray St,Glasgow G32 9DX',0141-357-7419,'cfarrel@gmail.com','********');
insert into PrivateOwner values('CO40','Tina','Murphy','63 Well St,Glasgow G42',0141-943-1728,'tinam@hotmail.com','********');
insert into PrivateOwner values('CO93','Tony','Shaw','12 ParkPl,Glasgow G4 0QR',0141-225-7025,'tony.shaw@ark.com','********');
...
insert into Registration values('CR62','B007','SA9','2012-04-07');
